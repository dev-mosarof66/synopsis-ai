  ...
  return (
    <section className="w-full min-h-screen flex-1 flex flex-col pt-0 sm:pt-24 relative z-40">
      ...
      <div className="w-full flex flex-col justify-center items-center gap-6 relative z-40">
        ...
        <h3 className="w-full max-w-3xl px-10 text-center text-xl  lg:text-2xl xl:text-3xl font-semibold">
          Watch how Sommaire transforms this <span className="text-rose-700">Next.js course PDF</span> into an
